...
func main() {
	...
	jsonToken := services.StructToJson(models.Session{AppId: "scm", AdminKey: "$2a$10$vwNlnoWznZXUoW6r6zDGSOwB6H/.Z9WbUC51JYdVJ93BXsF50dHCG", IdCompany: "c_1704969550804500", IdUser: "u_000000001"})
